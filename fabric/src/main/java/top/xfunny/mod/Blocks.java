...
public class Blocks {
    ...
    static {
        ...
        OTIS_SERIES_1_LANTERN_SCREEN_1_HORIZONTAL_EVEN = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "otis_series_1_lantern_screen_1_horizontal_even"), () -> new Block(new OtisSeries1LanternScreen1HorizontalEven()), CreativeModeTabs.YTE_LIFT_FIXTURES);
        OTIS_SERIES_1_LANTERN_SCREEN_1_HORIZONTAL_ODD = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "otis_series_1_lantern_screen_1_horizontal_odd"), () -> new Block(new OtisSeries1LanternScreen1HorizontalOdd()), CreativeModeTabs.YTE_LIFT_FIXTURES);
